 ...
 */
@InjectViewState
public class ListPagePresenter extends BasePresenter<ListView> {
    ...
    public void loadData() {
        if (isNetworkConnected()) {
            loadData(getRequestModel());
        } else
            getViewState().showMsg(R.string.error_no_internet_connection);
    }

    @NonNull
    private CompanyListRequestModel getRequestModel() {
