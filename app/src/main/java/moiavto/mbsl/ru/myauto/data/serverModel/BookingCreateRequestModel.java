...
/**
 * Модель запроса бронирования
 **/
@ApiModel(description = "Модель запроса бронирования")
public class BookingCreateRequestModel {
    ...
    public BookingCreateRequestModel(Integer companyId, String bookingDate, String bookingTime, Integer carId, List<Integer> services) {
    ...
    /**
     * Список идентификаторов заказанных услуг
     **/
    @ApiModelProperty(required = true, value = "Список идентификаторов заказанных услуг")
    ...
    public boolean equals(Object o) {
        ...
        BookingCreateRequestModel bookingCreateRequestModel = (BookingCreateRequestModel) o;
        return (this.companyId == null ? bookingCreateRequestModel.companyId == null : this.companyId.equals(bookingCreateRequestModel.companyId)) &&
                (this.bookingDate == null ? bookingCreateRequestModel.bookingDate == null : this.bookingDate.equals(bookingCreateRequestModel.bookingDate)) &&
                (this.bookingTime == null ? bookingCreateRequestModel.bookingTime == null : this.bookingTime.equals(bookingCreateRequestModel.bookingTime)) &&
                (this.carId == null ? bookingCreateRequestModel.carId == null : this.carId.equals(bookingCreateRequestModel.carId)) &&
                (this.services == null ? bookingCreateRequestModel.services == null : this.services.equals(bookingCreateRequestModel.services));
    }
    ...
    public String toString() {
        ...
        sb.append("class BookingCreateRequestModel {\n");
