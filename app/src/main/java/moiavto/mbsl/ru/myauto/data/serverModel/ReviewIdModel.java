...
/**
 * Модель идентификатора отзыва
 **/
@ApiModel(description = "Модель идентификатора отзыва")
public class ReviewIdModel {
    ...
    public boolean equals(Object o) {
        ...
        ReviewIdModel reviewIdModel = (ReviewIdModel) o;
        return (this.reviewId == null ? reviewIdModel.reviewId == null : this.reviewId.equals(reviewIdModel.reviewId));
    }
