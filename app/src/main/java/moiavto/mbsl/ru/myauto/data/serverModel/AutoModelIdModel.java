...
/**
 * Модель идентификатора модели автомобиля
 **/
@ApiModel(description = "Модель идентификатора модели автомобиля")
public class AutoModelIdModel {

    @SerializedName("autoModelId")
    private Integer autoModelId = null;

    public AutoModelIdModel(Integer autoModelId) {
     ...
     **/
    @ApiModelProperty(value = "Идентификатор модели автомобиля")
    ...
    public boolean equals(Object o) {
        ...
        AutoModelIdModel autoModelIdModel = (AutoModelIdModel) o;
        return (this.autoModelId == null ? autoModelIdModel.autoModelId == null : this.autoModelId.equals(autoModelIdModel.autoModelId));
    }
    ...
    public String toString() {
        ...
        sb.append("class AutoModelIdModel {\n");
