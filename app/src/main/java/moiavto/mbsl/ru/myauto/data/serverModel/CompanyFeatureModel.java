...
/**
 * Модель характеристики компании
 **/
@ApiModel(description = "Модель характеристики компании")
public class CompanyFeatureModel {

    @SerializedName("companyFeatureId")
    private Integer companyFeatureId = null;
    @SerializedName("name")
    private String name = null;
    @SerializedName("icon")
    private String icon = null;

    public CompanyFeatureModel() {
    }

    public CompanyFeatureModel(Integer companyFeatureId) {
    ...
    public Integer getCompanyFeatureId() {
        return companyFeatureId;
    }

    public void setCompanyFeatureId(Integer companyFeatureId) {
        this.companyFeatureId = companyFeatureId;
    }
     ...
     **/
    @ApiModelProperty(required = true, value = "Название характеристики")
     ...
     * Имя значка/ресурса
     **/
    @ApiModelProperty(required = true, value = "Имя значка/ресурса")
    ...
    public boolean equals(Object o) {
        ...
        CompanyFeatureModel companyFeatureModel = (CompanyFeatureModel) o;
        return (this.companyFeatureId == null ? companyFeatureModel.companyFeatureId == null : this.companyFeatureId.equals(companyFeatureModel.companyFeatureId)) &&
                (this.name == null ? companyFeatureModel.name == null : this.name.equals(companyFeatureModel.name)) &&
                (this.icon == null ? companyFeatureModel.icon == null : this.icon.equals(companyFeatureModel.icon));
    }

    @Override
    public int hashCode() {
        int result = 17;
        result = 31 * result + (this.companyFeatureId == null ? 0 : this.companyFeatureId.hashCode());
    ...
    public String toString() {
        ...
        sb.append("class CompanyFeatureModel {\n");

        sb.append("  companyFeatureId: ").append(companyFeatureId).append("\n");
