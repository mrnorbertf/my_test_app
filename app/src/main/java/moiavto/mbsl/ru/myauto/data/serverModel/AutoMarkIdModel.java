...
/**
 * Модель идентификатора марки автомобиля
 **/
@ApiModel(description = "Модель идентификатора марки автомобиля")
public class AutoMarkIdModel {

    @SerializedName("autoMarkId")
    private Integer autoMarkId = null;

    public AutoMarkIdModel(Integer autoMarkId) {
    ...
    public boolean equals(Object o) {
        ...
        AutoMarkIdModel autoMarkIdModel = (AutoMarkIdModel) o;
        return (this.autoMarkId == null ? autoMarkIdModel.autoMarkId == null : this.autoMarkId.equals(autoMarkIdModel.autoMarkId));
    }
    ...
    public String toString() {
        ...
        sb.append("class AutoMarkIdModel {\n");
