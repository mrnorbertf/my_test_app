 ...
 **/
@ApiModel(description = "Модель услуги компании")
public class CompanyServiceModel {

    @SerializedName("companyServiceId")
    private Integer companyServiceId = null;
    @SerializedName("name")
     ...
     **/
    @ApiModelProperty(required = true, value = "Идентификатор услуги")
     ...
     * Название услуги
     **/
    @ApiModelProperty(required = true, value = "Название услуги")
     ...
     * Стоимость
     **/
    @ApiModelProperty(required = true, value = "Стоимость")
    ...
    /**
     * Время услуги в минутах
     **/
    @ApiModelProperty(value = "Время услуги в минутах")
    ...
    public boolean equals(Object o) {
        ...
        CompanyServiceModel companyServiceModel = (CompanyServiceModel) o;
        return (this.companyServiceId == null ? companyServiceModel.companyServiceId == null : this.companyServiceId.equals(companyServiceModel.companyServiceId)) &&
                (this.name == null ? companyServiceModel.name == null : this.name.equals(companyServiceModel.name)) &&
                (this.price == null ? companyServiceModel.price == null : this.price.equals(companyServiceModel.price)) &&
                (this.duration == null ? companyServiceModel.duration == null : this.duration.equals(companyServiceModel.duration)) &&
                (this.discount == null ? companyServiceModel.discount == null : this.discount.equals(companyServiceModel.discount)) &&
                (this.actionDescription == null ? companyServiceModel.actionDescription == null : this.actionDescription.equals(companyServiceModel.actionDescription));
    }


    public boolean equalsById(CompanyServiceModel item) {
        return item.getCompanyServiceId().equals(this.companyServiceId);
    }

    public boolean equalsById(Integer id) {
        return id.equals(this.companyServiceId);
    }

    @Override
    public int hashCode() {
        int result = 17;
        result = 31 * result + (this.companyServiceId == null ? 0 : this.companyServiceId.hashCode());
    ...
    public String toString() {
        ...
        sb.append("class CompanyServiceModel {\n");

        sb.append("  companyServiceId: ").append(companyServiceId).append("\n");
