 ...
 * Модель помощи
 **/
@ApiModel(description = "Модель помощи")
public class HelpModel implements Serializable {
     ...
     **/
    @ApiModelProperty(required = true, value = "Идентификатор помощи")
    ...
    /**
     * Наименование раздела помощи
     **/
    @ApiModelProperty(required = true, value = "Наименование раздела помощи")
     ...
     * Текст помощи
     **/
    @ApiModelProperty(required = true, value = "Текст помощи")
    ...
    public boolean equals(Object o) {
        ...
        HelpModel helpModel = (HelpModel) o;
        return (this.helpId == null ? helpModel.helpId == null : this.helpId.equals(helpModel.helpId)) &&
                (this.subject == null ? helpModel.subject == null : this.subject.equals(helpModel.subject)) &&
                (this.detailText == null ? helpModel.detailText == null : this.detailText.equals(helpModel.detailText));
    }
