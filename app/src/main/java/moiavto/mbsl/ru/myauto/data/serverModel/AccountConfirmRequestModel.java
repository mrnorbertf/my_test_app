...
/**
 * Модель запроса подтверждения аккаунта
 **/
@ApiModel(description = "Модель запроса подтверждения аккаунта")
public class AccountConfirmRequestModel {

    @SerializedName("checkCode")
    private String checkCode = null;

    public AccountConfirmRequestModel(String checkCode) {
     ...
     **/
    @ApiModelProperty(required = true, value = "Код подтверждения аккаунта")
    ...
    public boolean equals(Object o) {
        ...
        AccountConfirmRequestModel accountConfirmRequestModel = (AccountConfirmRequestModel) o;
        return (this.checkCode == null ? accountConfirmRequestModel.checkCode == null : this.checkCode.equals(accountConfirmRequestModel.checkCode));
    }

    @Override
    public int hashCode() {
        int result = 17;
        result = 31 * result + (this.checkCode == null ? 0 : this.checkCode.hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append("class AccountConfirmRequestModel {\n");
