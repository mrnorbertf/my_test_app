...
/**
 * Модель идентификатора автомобиля
 **/
@ApiModel(description = "Модель идентификатора автомобиля")
public class AutoIdModel {

    @SerializedName("autoId")
    private Integer autoId = null;

    public AutoIdModel(Integer autoId) {
        this.autoId = autoId;
    }
    ...
    public boolean equals(Object o) {
        ...
        AutoIdModel autoIdModel = (AutoIdModel) o;
        return (this.autoId == null ? autoIdModel.autoId == null : this.autoId.equals(autoIdModel.autoId));
    }
