...
/**
 * Модель ответа подготовки бронирования
 **/
@ApiModel(description = "Модель ответа подготовки бронирования")
public class BookingPrepareResponseModel {

    @SerializedName("bookingDates")
    private List<BookingDateModel> bookingDates = null;
    @SerializedName("cars")
    private List<BookingCarModel> cars = null;

    /**
     * Список дат, доступных для записи
     **/
    @ApiModelProperty(required = true, value = "Список дат, доступных для записи")
    public List<BookingDateModel> getBookingDates() {
        return bookingDates;
    }

    public void setBookingDates(List<BookingDateModel> bookingDates) {
     ...
     **/
    @ApiModelProperty(required = true, value = "Список автомобилей пользователя")
    public List<BookingCarModel> getCars() {
        return cars;
    }

    public void setCars(List<BookingCarModel> cars) {
        this.cars = cars;
    }
    ...
    public boolean equals(Object o) {
        ...
        BookingPrepareResponseModel bookingPrepareResponseModel = (BookingPrepareResponseModel) o;
        return (this.bookingDates == null ? bookingPrepareResponseModel.bookingDates == null : this.bookingDates.equals(bookingPrepareResponseModel.bookingDates)) &&
                (this.cars == null ? bookingPrepareResponseModel.cars == null : this.cars.equals(bookingPrepareResponseModel.cars));
    }

    @Override
    public int hashCode() {
        int result = 17;
        result = 31 * result + (this.bookingDates == null ? 0 : this.bookingDates.hashCode());
        result = 31 * result + (this.cars == null ? 0 : this.cars.hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append("class BookingPrepareResponseModel {\n");

        sb.append("  bookingDates: ").append(bookingDates).append("\n");
