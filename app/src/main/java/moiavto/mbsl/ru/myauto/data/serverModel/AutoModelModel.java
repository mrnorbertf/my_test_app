 ...
 **/
@ApiModel(description = "Модель модели автомобиля")
public class AutoModelModel implements Naming {
    ...
    public boolean equals(Object o) {
        ...
        AutoModelModel autoModelModel = (AutoModelModel) o;
        return (this.autoModelId == null ? autoModelModel.autoModelId == null : this.autoModelId.equals(autoModelModel.autoModelId)) &&
                (this.name == null ? autoModelModel.name == null : this.name.equals(autoModelModel.name));
    }
    ...
    public String toString() {
        ...
        sb.append("class AutoModelModel {\n");
