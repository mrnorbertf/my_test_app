...
/**
 * Модель запроса загрузки аватара
 **/
@ApiModel(description = "Модель запроса загрузки аватара")
public class AccountUploadAvatarRequestModel {

    @SerializedName("avatar")
    private byte[] avatar = null;

    /**
     * Изображение, закодированное в формате \"multipart/form-data\"
     **/
    @ApiModelProperty(required = true, value = "Изображение, закодированное в формате \"multipart/form-data\"")
    ...
    public boolean equals(Object o) {
        ...
        AccountUploadAvatarRequestModel accountUploadAvatarRequestModel = (AccountUploadAvatarRequestModel) o;
        return (this.avatar == null ? accountUploadAvatarRequestModel.avatar == null : this.avatar.equals(accountUploadAvatarRequestModel.avatar));
    }
    ...
    public String toString() {
        ...
        sb.append("class AccountUploadAvatarRequestModel {\n");
