 ...
 **/
@ApiModel(description = "Модель цвета автомобиля")
public class AutoColorModel implements Naming {
     ...
     * Наименование цвета
     **/
    @ApiModelProperty(required = true, value = "Наименование цвета")
     ...
     **/
    @ApiModelProperty(value = "Цвет автомобиля в формате")
    ...
    public boolean equals(Object o) {
        ...
        AutoColorModel autoColorModel = (AutoColorModel) o;
        return (this.autoColorId == null ? autoColorModel.autoColorId == null : this.autoColorId.equals(autoColorModel.autoColorId)) &&
                (this.name == null ? autoColorModel.name == null : this.name.equals(autoColorModel.name)) &&
                (this.rgb == null ? autoColorModel.rgb == null : this.rgb.equals(autoColorModel.rgb));
    }
    ...
    public String toString() {
        ...
        sb.append("class AutoColorModel {\n");
