 ...
 **/
@ApiModel(description = "Модель марки автомобиля")
public class AutoMarkModel implements Naming {
     ...
     **/
    @ApiModelProperty(required = true, value = "Идентификатор марки автомобиля")
     ...
     * Наименование марки
     **/
    @ApiModelProperty(required = true, value = "Наименование марки")
    ...
    public boolean equals(Object o) {
        ...
        AutoMarkModel autoMarkModel = (AutoMarkModel) o;
        return (this.autoMarkId == null ? autoMarkModel.autoMarkId == null : this.autoMarkId.equals(autoMarkModel.autoMarkId)) &&
                (this.name == null ? autoMarkModel.name == null : this.name.equals(autoMarkModel.name));
    }
