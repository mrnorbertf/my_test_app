...
/**
 * Модель ответа запроса бронирования
 **/
@ApiModel(description = "Модель ответа запроса бронирования")
public class BookingCreateResponseModel {
    ...
    /**
     * Статус операции. “ok” – операция завершена успешно, “engaged” – указанное время занято, требуется вывести сообщение из поля message и повторно получить список доступного для записи времени
     **/
    @ApiModelProperty(required = true, value = "Статус операции. “ok” – операция завершена успешно, “engaged” – указанное время занято, требуется вывести сообщение из поля message и повторно получить список доступного для записи времени")
    ...
    public boolean isEngaged() {
        return status.toLowerCase().equals("engaged");
    }
    ...
    /**
     * Идентификатор бронирования (в случае успешного создания)
     **/
    @ApiModelProperty(value = "Идентификатор бронирования (в случае успешного создания)")
    ...
    public boolean equals(Object o) {
        ...
        BookingCreateResponseModel bookingCreateResponseModel = (BookingCreateResponseModel) o;
        return (this.status == null ? bookingCreateResponseModel.status == null : this.status.equals(bookingCreateResponseModel.status)) &&
                (this.message == null ? bookingCreateResponseModel.message == null : this.message.equals(bookingCreateResponseModel.message)) &&
                (this.bookingId == null ? bookingCreateResponseModel.bookingId == null : this.bookingId.equals(bookingCreateResponseModel.bookingId));
    }
    ...
    public String toString() {
        ...
        sb.append("class BookingCreateResponseModel {\n");
