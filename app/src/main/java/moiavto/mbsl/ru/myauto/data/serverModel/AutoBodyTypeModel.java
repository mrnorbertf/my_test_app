 ...
 **/
@ApiModel(description = "Модель типа кузова автомобиля")
public class AutoBodyTypeModel implements Naming {
     ...
     **/
    @ApiModelProperty(required = true, value = "Наименование типа кузова")
    ...
    /**
     * Признак выбранного значения
     **/
    @ApiModelProperty(value = "Признак выбранного значения")
    ...
    public boolean equals(Object o) {
        ...
        AutoBodyTypeModel autoBodyTypeModel = (AutoBodyTypeModel) o;
        return (this.autoBodyTypeId == null ? autoBodyTypeModel.autoBodyTypeId == null : this.autoBodyTypeId.equals(autoBodyTypeModel.autoBodyTypeId)) &&
                (this.name == null ? autoBodyTypeModel.name == null : this.name.equals(autoBodyTypeModel.name)) &&
                (this.isSelected == null ? autoBodyTypeModel.isSelected == null : this.isSelected.equals(autoBodyTypeModel.isSelected));
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (this.isSelected == null ? 0 : this.isSelected.hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append("class AutoBodyTypeModel {\n");
