...
/**
 * Модель автомобиля для бронирования
 **/
@ApiModel(description = "Модель автомобиля для бронирования")
public class BookingCarModel {
    ...
    /**
     * Список услуг для автомобиля
     **/
    @ApiModelProperty(required = true, value = "Список услуг для автомобиля")
    ...
    public boolean equals(Object o) {
        ...
        BookingCarModel bookingCarModel = (BookingCarModel) o;
        return (this.carId == null ? bookingCarModel.carId == null : this.carId.equals(bookingCarModel.carId)) &&
                (this.name == null ? bookingCarModel.name == null : this.name.equals(bookingCarModel.name)) &&
                (this.services == null ? bookingCarModel.services == null : this.services.equals(bookingCarModel.services));
    }
    ...
    public String toString() {
        ...
        sb.append("class BookingCarModel {\n");
