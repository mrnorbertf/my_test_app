...
/**
 * Модель ответа создания аккаунта
 **/
@ApiModel(description = "Модель ответа создания аккаунта")
public class AccountCreateResponseModel {
     ...
     **/
    @ApiModelProperty(required = true, value = "Статус учетной записи пользователя")
    ...
    /**
     * Уникальный идентификатор экземпляра приложения. Используется в заголовке `X-Auth-AppId`
     **/
    @ApiModelProperty(required = true, value = "Уникальный идентификатор экземпляра приложения. Используется в заголовке `X-Auth-AppId`")
    ...
    /**
     * Секретный ключ экземпляра приложения. Используется для подписи методов API
     **/
    @ApiModelProperty(required = true, value = "Секретный ключ экземпляра приложения. Используется для подписи методов API")
    ...
    public boolean equals(Object o) {
        ...
        AccountCreateResponseModel accountCreateResponseModel = (AccountCreateResponseModel) o;
        return (this.status == null ? accountCreateResponseModel.status == null : this.status.equals(accountCreateResponseModel.status)) &&
                (this.appId == null ? accountCreateResponseModel.appId == null : this.appId.equals(accountCreateResponseModel.appId)) &&
                (this.appSecret == null ? accountCreateResponseModel.appSecret == null : this.appSecret.equals(accountCreateResponseModel.appSecret));
    }
    ...
    public String toString() {
        ...
        sb.append("class AccountCreateResponseModel {\n");
